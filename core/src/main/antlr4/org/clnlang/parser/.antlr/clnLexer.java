...
public class clnLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PACKAGE", "IMPORT", "EXPOSE", "STRUCT", "UNION", "VAR", "IF", "ELSE", 
			"WHILE", "SWITCH", "CASE", "DEFAULT", "RETURN", "INT_T", "BOOL_T", "STRING_T", 
			"DEC_T", "BOOL_LIT", "INT_LIT", "DEC_LIT", "STRING_LIT", "LPAREN", "RPAREN", 
			"LBRACE", "RBRACE", "LBRACK", "RBRACK", "SEMI", "COMMA", "COLON", "DOT", 
			"ASSIGN", "PLUS", "MINUS", "STAR", "SLASH", "INC", "DEC", "NOT", "AND", 
			"OR", "EQ", "NEQ", "LT", "LTE", "GT", "GTE", "ID", "LINE_COMMENT", "BLOCK_COMMENT", 
			"WS"
		};
	}
	...
	public clnLexer(CharStream input) {
		super(input);
